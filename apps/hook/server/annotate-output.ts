...
/**
 * Direct structured annotate gates (`--gate --json`, not `--hook`) are the
 * only transport where a tab's abandonment can be safely resolved
 * automatically — the caller is already blocked on a
