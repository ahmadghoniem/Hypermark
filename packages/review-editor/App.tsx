    ...
    <ThemeProvider defaultTheme="dark" manageFavicon>
      ...
      >
        ...
        <ReviewHeader
          ...
          baseBehindRemote={baseBehindRemote}
          isFetchingBase={isFetchingBase}
          handleFetchBase={handleFetchBase}
          decision={{ spec: reviewDecisionSpec, handlers: reviewDecisionHandlers }}
          busyWithDecision={busyWithDecision}
          isSendingFeedback={isSendingFeedback}
          isApproving={isApproving}
          handleCopyFeedback={handleCopyFeedback}
          copyFeedback={copyFeedback}
          reviewSidebar={reviewSidebar}
          totalAnnotationCount={totalAnnotationCount}
          onToggleAllFilesCollapsed={onToggleAllFilesCollapsed}
          allFilesAllCollapsed={allFilesAllCollapsed}
          diffStyle={diffStyle}
        />
            ...
            {files.length > 0 ? (
              ...
              <div className="h-full flex items-center justify-center">
                <div className="text-center space-y-3 max-w-md px-8">
                  <div className={`mx-auto size-12 rounded-full flex items-center justify-center ${diffError ? 'bg-destructive/10' : 'bg-muted/50'}`}>
                    {diffError ? (
                  ...
                  <div>
                    {diffError ? (
                      <>
                        ...
                        <p className="text-xs text-muted-foreground mt-1 max-w-sm wrap-break-word line-clamp-3">{diffError}</p>
                      </>
                    ) : (
                      <>
