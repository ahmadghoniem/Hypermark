...
import { sanitizeBlockHtml } from '@hypermark/ui/utils/sanitizeHtml';
      ...
      <CommentMeta
        leading={
          <>
            ...
            >
              <svg className={`size-3.5 transition-transform ${collapsed ? '' : 'rotate-90'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
