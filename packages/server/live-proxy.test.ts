...
const BRIDGE_BODY = "window.__hypermarkLiveConfig = {\"token\":\"tok-abc123\",\"editorOrigins\":[\"http://localhost:4100\",\"http://127.0.0.1:4100\"]}; /* bridge */";
...
describe("live proxy: security posture", () => {
  ...
  test("the proxy origin and bind are always loopback", () => {
