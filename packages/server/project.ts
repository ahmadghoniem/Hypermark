 ...
 *
 * Pure string functions re-exported from @hypermark/shared/project.
 * detectProjectName() is Bun-specific (uses Bun.$).
 */

import { $ } from "bun";
import { extractRepoName, extractDirName } from "@hypermark/shared/project";
export { sanitizeTag, extractRepoName, extractDirName } from "@hypermark/shared/project";
