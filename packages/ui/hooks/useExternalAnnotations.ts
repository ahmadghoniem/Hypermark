 ...
 *
 * Default = Hypermark's SSE→polling behavior, verbatim. A host (Workspaces)
...
/**
 * Default transport — Hypermark's verbatim SSE→polling wire.
...
/** Reset to the default (Hypermark SSE→polling) transport. Mainly for tests. */
