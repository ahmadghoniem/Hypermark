...
export const ResizeHandle: React.FC<Props> = ({
  ...
  return (
    <div
      className={`relative w-0 cursor-col-resize shrink-0 group${className ? ` ${className}` : ''}`}
    >
      ...
      <div
        ...
        className={`absolute inset-y-0 -inset-x-0.5  transition-colors ${
