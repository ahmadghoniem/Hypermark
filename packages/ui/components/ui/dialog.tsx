...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Backdrop
    ...
    className={cn(
      "fixed inset-0 z-dialog bg-black/55 backdrop-blur-[2px]",
...
>(({ backdropClassName, className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    ...
    <div className="pn-visible-viewport-overlay z-dialog pointer-events-none flex items-center justify-center">
      <DialogPrimitive.Popup
        ref={ref}
        className={cn(
          "relative pointer-events-auto z-dialog w-full min-h-0",
