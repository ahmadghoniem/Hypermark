 ...
 * review, or annotate server WITHOUT redirecting HYPERMARK_DATA_DIR (plan
 ...
 * ~/.hypermark/feedback — on CI and on every machine that runs `bun test`.
 ...
 * HYPERMARK_FEEDBACK_HISTORY=1 in a contributor's shell must not silently
